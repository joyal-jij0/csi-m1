...
import {createEvent, updateEvent, deleteEvent, getEvent, getEvents, getTopThree, getSortedEvents} from "../controllers/event.controller"
...
router.route("/retrieveAll").get(verifyJWT, getSortedEvents);
router.route("/adminRetrieveAll").get(verifyJWT, getEvents);
